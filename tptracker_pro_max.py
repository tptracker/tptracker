    ...
    while active:
        ...
        while line:
            if not alert:
                ...
                send_email(NAME, dt_string, NAME_EMAIL, USERNAME, DOMAIN)
                return 'Done'
            # read the next line
            line = opened.readline()
            if line == '0\n' or line == '0':
...
def send_email(location: str, date: str, name: str, username: str, domain: str) -> None:
    email = EmailMessage()
...
if __name__ == '__main__':
    ...
    while call:
        ...
        NAME_EMAIL = input('Enter the First and Last name of the alert reciever')
